defmodule Test4it210.AssociationRule do
  ...
  defmodule AssociationRuleQuestion do
    @type t :: %__MODULE__{
  ...
  @spec generate_association_rule_question() :: AssociationRuleQuestion.t()
  def generate_association_rule_question() do
    contingency_table = generate_contingency_table()

    %AssociationRuleQuestion{
  ...
  defp compute_total(%ContingencyTable{a_c: a_c, a_not_c: a_not_c, not_a_c: not_a_c, not_a_not_c: not_a_not_c}) do
    a_c + a_not_c + not_a_c + not_a_not_c
  end

  @spec generate_association_rule_question() :: ContingencyTable.t()
